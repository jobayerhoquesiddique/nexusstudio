    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-background px-4 py-24">
      ...
      <div className="container relative z-10 max-w-5xl">
        <div className="flex flex-col items-center text-center mb-8">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold mb-6 tracking-tight">
            ...
            <span className="block overflow-hidden mt-2">
              <span className="text-gradient-primary block animate-fade-in" style={{ animationDelay: "0.4s" }}>
                NEXUS STUDIO
              </span>
            </span>
          </h1>
          ...
          <div className="overflow-hidden">
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto my-6 animate-fade-in" style={{ animationDelay: "0.6s" }}>
              A parent group of Crypto Nexus Blockchain, NFT & Crypto Agency and Byte Studio - 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 animate-fade-in" style={{ animationDelay: "1s" }}>
          <div className="glass-card p-6 transform hover:scale-105 transition-all hover:shadow-nexus/20 hover:shadow-lg">
            <h3 className="font-heading font-bold text-2xl mb-2">Nexus Studio</h3>
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <Button 
          variant="ghost" 
          size="icon" 
          className="rounded-full border border-muted h-12 w-12"
